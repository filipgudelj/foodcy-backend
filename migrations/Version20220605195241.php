 ...
 */
final class Version20220605195241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__advice AS SELECT id, title, content FROM advice');
        ...
        $this->addSql('INSERT INTO advice (id, title, content) SELECT id, title, content FROM __temp__advice');
        $this->addSql('DROP TABLE __temp__advice');
        $this->addSql('CREATE INDEX IDX_64820E8DF675F31B ON advice (author_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, title, ingredients, steps FROM recipe');
        ...
        $this->addSql('INSERT INTO recipe (id, title, ingredients, steps) SELECT id, title, ingredients, steps FROM __temp__recipe');
